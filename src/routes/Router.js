...
/* ****Pages***** */
const ModernDash = Loadable(lazy(() => import('../views/dashboard/Dashboard')));
...
const Invoices = Loadable(lazy(() => import('../views/main-store/invoices/Invoices')));
const InvoiceCreate = Loadable(lazy(() => import('../views/main-store/invoices/Create')));
const InvoiceDetail = Loadable(lazy(() => import('../views/main-store/invoices/Detail')));
const InvoiceEdit = Loadable(lazy(() => import('../views/main-store/invoices/Edit')));
...
const Router = [
  {
    ...
    children: [
      ...
      { path: '/main-store/invoice/create', element: <InvoiceCreate /> },
      { path: '/main-store/invoice/detail/:id', element: <InvoiceDetail /> },
      { path: '/main-store/invoice/edit/:id', element: <InvoiceEdit /> },
