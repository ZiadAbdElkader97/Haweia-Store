    ...
    <Box>
      ...
      >
        ...
        <Box display="flex" gap={1}>
          ...
          <Button variant="contained" color="primary" component={Link} to="/main-store/invoice/create">
            New Invoice
          </Button>
        </Box>
      </Stack>
                ...
                <TableCell align="center">
                  <Tooltip title="Edit Invoice">
                    <IconButton
                      color="success"
                      component={Link}
                      to={`/main-store/invoice/edit/${invoice.billFrom}`}
                    >
                      <IconEdit width={22} />
                    </IconButton>
                  </Tooltip>
                  <Tooltip title="View Invoice">
                    <IconButton
                      color="primary"
                      component={Link}
                      to={`/main-store/invoice/detail/${invoice.billFrom}`}
                    >
                      <IconEye width={22} />
                    </IconButton>
                  </Tooltip>
